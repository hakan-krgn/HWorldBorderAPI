...
public class HWorldBorder_v1_11_R1 implements HWorldBorder {
    ...
    public HWorldBorder_v1_11_R1(Location location, int size, int damageAmount, int damageBuffer, int warningDistance, int warningTime) {
