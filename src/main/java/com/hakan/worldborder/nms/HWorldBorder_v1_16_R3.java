...
public class HWorldBorder_v1_16_R3 implements HWorldBorder {
    ...
    public HWorldBorder_v1_16_R3(Location location, int size, int damageAmount, int damageBuffer, int warningDistance, int warningTime, HBorderColor color) {
