...
public class HWorldBorder_v1_12_R1 implements HWorldBorder {
    ...
    public HWorldBorder_v1_12_R1(Location location, int size, int damageAmount, int damageBuffer, int warningDistance, int warningTime, HBorderColor color) {
