...
public class HWorldBorder_v1_9_R2 implements HWorldBorder {
    ...
    public HWorldBorder_v1_9_R2(Location location, int size, int damageAmount, int damageBuffer, int warningDistance, int warningTime, HBorderColor color) {
